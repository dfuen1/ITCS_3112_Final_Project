...
public class AddClothingItemPage implements ActionListener {
    ...
    public void initialize() {
        ...
        // i don't think someone will have more than 100,000 of the same piece of
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        // depending on the category chosen in the combo box, the applicable
        // types will be displayed in the types combo box
        if (e.getSource() == categoryChoices) {
            ...
            if (selectedString == Categories.TOP) {
                ...
                typeChoices.removeAllItems();
                Types[] availableTypes = { Types.HATS, Types.SUNGLASSES, Types.BELTS, Types.GLOVES, Types.SCARVES,
                        Types.OTHER };
                ...
                typeChoices.removeAllItems();
                Types[] availableTypes = { Types.HOODIE, Types.JACKET, Types.SWEATSHIRT, Types.SWEATER, Types.COAT,
                        Types.OTHER };
