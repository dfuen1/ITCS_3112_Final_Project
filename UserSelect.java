...
public class UserSelect implements ActionListener, ListSelectionListener {
    ...
    public void initialization() {
        ...
        JLabel menuTitle = new JLabel("Wardrobe Tracker");
        ...
        //userSelectPanel.setBackground(Color.RED);
        ...
        JLabel selectLabel = new JLabel("Select Wardrobe");
        selectLabel.setFont(new Font("Lucida Grande", Font.PLAIN, 15));
        selectLabel.setForeground(Color.WHITE);
        selectLabel.setBounds(10, 8, 120, 20);
        //scrollableUserSelect.setBounds(10, 20, 510, 200);
        scrollableUserSelect.setBounds(10, 30, 510, 200);
        ...
        userSelectPanel.add(selectLabel);
    ...
    // @Override
    // public Component getListCellRendererComponent(JList <File>l list, File file,
